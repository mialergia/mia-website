...
export const IMAGES = ['image-1.png', 'image-2.png', 'image-3.png', 'image-4.png', 'image-5.png', 'image-6.png', 'image-7.png'];

export const DOCTORS_TEAM = [
  {name: 'Carina Almirón', description: 'Doctora, especialista en Otorrinolaringología', image: 'carina-almiron.png'},
  {name: 'Mariana Bonifacino', description: 'Doctora, Postgrado de Alergología', image: 'mariana-bonifacino.png'},
